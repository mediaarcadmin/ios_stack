...
static inline uint8_t css_computed_page_break_after(
		const css_computed_style *style)
{
	if (style->page != NULL) {
...
static inline uint8_t css_computed_page_break_before(
		const css_computed_style *style)
{
	if (style->page != NULL) {
...
static inline uint8_t css_computed_page_break_inside(
	    const css_computed_style *style)
{
	if (style->page != NULL) {
