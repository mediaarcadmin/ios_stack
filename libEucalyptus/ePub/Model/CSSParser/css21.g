...
//
imports
	:	IMPORT^ (STRING|URI) (medium (COMMA medium)*)? SEMI!
	;
...
declaration
	: property COLON expr prio? -> ^(DECLARATION ^(PROPERTY property) ^(VALUE expr) prio?)
	;
...
IMPORTANT	: '!' (WS|COMMENT)* I M P O R T A N T	;
