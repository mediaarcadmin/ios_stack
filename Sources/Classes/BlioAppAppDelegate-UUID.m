...
- (void)checkDevice {
    // AC TESTING
    NSString* uuidStr = [[NSUserDefaults standardUserDefaults] stringForKey:kBlioDeviceIDDefaultsKey]; 
    if (!uuidStr) {
        // AC TESTING
		[BlioAlertManager showAlertWithTitle:NSLocalizedString(@"New Device",@"\"New Device\" alert message title") 
									 message:@"The saved UUID is NULL."
									delegate:nil 
						   cancelButtonTitle:nil
						   otherButtonTitles:@"OK", nil];
        CFUUIDRef uuid = CFUUIDCreate(kCFAllocatorDefault);
        uuidStr = CFUUIDCreateString(kCFAllocatorDefault, uuid);
        [[NSUserDefaults standardUserDefaults] setObject:(id)uuidStr forKey:kBlioDeviceIDDefaultsKey];
    ...
    // AC TESTING
		...
		[BlioAlertManager showAlertWithTitle:NSLocalizedString(@"Old Device",@"\"Old Device\" alert message title") 
									 message:@"The saved UUID is not NULL."
									delegate:nil 
						   cancelButtonTitle:nil
						   otherButtonTitles:@"OK", nil];
