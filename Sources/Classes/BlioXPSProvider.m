...
- (THPair *)RGBABitmapDataForPage:(NSUInteger)page
    ...
    if (imageInfo) {
		...
		rowStride  = imageInfo->rowStride;
        height = imageInfo->height;
		width = imageInfo->widthInPixels;
		
		bitmapData = [[NSData alloc] initWithBytes:imageInfo->pBits length:height * rowStride];
		XPS_ReleaseImageMemory(imageInfo->pBits);
