        ...
        if ([BlioSocialManager canSendTweet]) {
            ...
            if([[UIDevice currentDevice] compareSystemVersion:@"5.1"] >= NSOrderedSame) {
                [BlioAlertManager showAlertWithTitle:NSLocalizedString(@"Twitter Not Setup",@"\"Twitter Not Setup\" alert message title")
                                             message:NSLocalizedStringWithDefaultValue(@"TWITTER_NOT_SETUP",nil,[NSBundle mainBundle],@"Twitter account settings were not found. Please enter your username and password in the Twitter Settings.",@"Alert message shown when no twitter account settings are found.")
                                            delegate:self 
