...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([[selectedBook valueForKey:@"processingState"] intValue] == kBlioBookProcessingStateComplete) {
		// AC TESTING
		if ( [[selectedBook xpsProvider] bookIsEncrypted] ) {
			[[selectedBook xpsProvider] bindToDRMLicense];
			if ([[selectedBook xpsProvider] decryptionAvailable])
...
- (void)bookSelected:(BlioLibraryBookView *)libraryBookView {
	...
	// AC TESTING
	[[[libraryBookView book] xpsProvider] bindToDRMLicense];
	if (![[[libraryBookView book] xpsProvider] decryptionAvailable])
		return;
